...
export const ONNX_MODELS: TranslatorModel[] = [
...

  {
    ...
    langCount: 92,
    speed: "fast",
    description: "Alibaba Qwen3.5 4B. Great quality-to-size ratio for in-browser translation.",
    score: { avg: 8.0, accuracy: 8.2, fluency: 8.3, style: 7.6, badge: "🟡", langCount: 92, verified: false },
  },
  {
    ...
    langCount: 92,
    speed: "medium",
    description: "Alibaba Qwen3.5 9B. Largest Qwen3.5 with prebuilt WebGPU support.",
    score: { avg: 8.2, accuracy: 8.4, fluency: 8.5, style: 7.8, badge: "🟡", langCount: 92, verified: false },
  },
  {
    ...
    langCount: 30,
    speed: "slow",
    description: "Meta Llama 3.1 70B Q3 via WebGPU. Requires 24 GB+ GPU.",
    score: { avg: 8.3, accuracy: 8.6, fluency: 8.5, style: 7.9, badge: "🟡", langCount: 30, verified: false },
  },
];
