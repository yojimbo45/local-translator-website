...
export const ONNX_MODELS: TranslatorModel[] = [
  ...
  // ── Large WebGPU models (experimental) ────────────────────────────────────
  {
    id: "gemma-4-31b-it-q4f16_1-MLC",
    backend: "mlc",
    name: "Gemma 4 31B",
    family: "Gemma 4",
    sizeHuman: "~19 GB",
    langCount: 227,
    speed: "slow",
    description: "Google Gemma 4 31B Q4 via WebGPU. Experimental — requires high-end GPU.",
    score: { avg: 7.7, accuracy: 8.1, fluency: 8.3, style: 7.5, badge: "🟡", langCount: 227, verified: false },
  },
  {
    id: "gemma-3-27b-it-q4f16_1-MLC",
    backend: "mlc",
    name: "Gemma 3 27B",
    family: "Gemma 3",
    sizeHuman: "~17 GB",
    langCount: 227,
    speed: "slow",
    description: "Google Gemma 3 27B Q4 via WebGPU. Experimental — requires high-end GPU.",
    score: { avg: 7.5, accuracy: 7.8, fluency: 8.2, style: 7.2, badge: "🟡", langCount: 227, verified: false },
  },
  {
    id: "Qwen3.5-35B-Instruct-q4f16_1-MLC",
    backend: "mlc",
    name: "Qwen3.5 35B",
    family: "Qwen3.5",
    sizeHuman: "~22 GB",
    langCount: 92,
    speed: "slow",
    description: "Alibaba Qwen3.5 35B Q4 via WebGPU. Experimental — requires high-end GPU.",
